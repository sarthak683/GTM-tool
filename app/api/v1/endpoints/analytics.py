...
# Response models live in analytics_schemas.py; re-imported here so every
# `response_model=` annotation below resolves exactly as it did before.
from app.api.v1.endpoints.analytics_schemas import (  # noqa: F401
    ForecastRow,
